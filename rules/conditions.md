...
The DM determines who might be surprised. If neither side tries to be stealthy, they automatically notice each other. Otherwise, the DM compares the Dexterity ([Stealth](skills.md#Stealth)) checks of anyone hiding with the passive Wisdom ([Perception](skills.md#Perception)) score of each creature on the opposing side. Any character or monster that doesn't notice a threat is [surprised](conditions.md#surprised) at the start of the encounter.
