...
The time it takes to don or doff armor [depends on the armor's category](getting-into-and-out-of-armor-donning-and-doffing-armor.md). A [shield](compendium/items/shield.md) can be donned or doffed as an action.
...
You can use your action to administer first aid to an [unconscious](conditions.md#unconscious) creature and attempt to stabilize it, which requires a successful DC 10 Wisdom ([Medicine](skills.md#Medicine)) check.
